...
public class GunLogic {
    ...
    private static final byte[] BULLET_TYPES = {LIGHT_BULLET, LIGHT_BULLET, LIGHT_BULLET, HEAVY_BULLET, STANDARD_BULLET, STANDARD_BULLET, SHOTGUN_BULLET, HEAVY_BULLET};
    private static final int[] SHOT_DELAY_MILLIS = {100, 20, 100, 600, 30, 120, 800, 1200};
    private static final int[] RELOAD_TIME_MILLIS = {1300, 1400, 1700, 2000, 2300, 2400, 2500, 3500};
    private static final byte[] DAMAGE_PER_HIT = {13, 13, 12, 35, 14, 17, 17, 50};
    private static final byte[] MAG_CAPACITY = {16, 25, 30, 6, 30, 30, 5, 5};
    ...
    private static float[] RELATIVE_BULLET_EXIT_POINT_Y = {-3, 0, 3, -8, 4, 1, -2, -5}; //CHANGE THESE AFTER MAKING GUN MODELS
